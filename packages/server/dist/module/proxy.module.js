...
const proxy_controller_1 = require("../controller/proxy.controller");
const proxy_service_1 = require("../service/proxy.service");
let ProxyModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            controllers: [proxy_controller_1.ProxyController],
            providers: [proxy_service_1.ProxyService, prisma_service_1.PrismaService],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var ProxyModule = _classThis = class {
    };
