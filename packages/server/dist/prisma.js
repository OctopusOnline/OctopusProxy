...
function prismaGenerate(databaseUrl) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      npx prisma generate --schema=${node_path_1.default.resolve(__dirname, '../prisma/schema.prisma')}
    `);
...
function prismaInit(databaseUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        yield Promise.all([
